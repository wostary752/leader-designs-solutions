        ...
        {SERVICES.map((s, i) => {
          ...
          return (
            <Link
              key={s.to}
              to={s.to}
              className="group glass-card rounded-3xl p-8 sm:p-10 flex flex-col lg:flex-row gap-8 hover:border-primary/40 transition-colors"
            >
              <div className="lg:w-1/3 flex items-start gap-5">
                <div className="text-5xl font-display font-bold text-primary/40">0{i + 1}</div>
                <div>
              ...
              <div className="lg:w-12 flex lg:items-center">
                <div className="size-12 rounded-full border border-border flex items-center justify-center group-hover:border-primary group-hover:text-primary group-hover:rotate-[-45deg] transition-all">
